const offerAcceptedMessage = (volunteerEmail, { name, title }) => ({
  ...
  html:
    ...
    `<p>Hello ${name}</p><br/>` +
    `<p> Thank you for offering your help. We're happy to announce you that your offer has just been approved. The title of the accepted offer is ${title}.</p><br/>` +
    `<p> Have an amazing day,</p>` +
    `<p> Together for Ukraine team</p>`,
});

const offerDeclinedMessage = (volunteerEmail, { name, title }) => ({
  from: `pw.idp.together.for.ukraine@gmail.com`,
  to: volunteerEmail,
  ...
  html:
    ...
    `<p>Hello ${name}</p><br/>` +
    `<p> Thank you for offering your help. Unfortunately, we decided not to move forward with your offer. The title of the declined offer is ${title}.</p><br/>` +
    `<p> Have an amazing day,</p>` +
    `<p> Together for Ukraine team</p>`,
});

const offerDeletedMessage = (volunteerEmail, { name, title }) => ({
  from: `pw.idp.together.for.ukraine@gmail.com`,
  to: volunteerEmail,
  ...
  html:
    ...
    `<p>Hello ${name}</p><br/>` +
    `<p> Thank you for offering your help. Unfortunately, we decided to remove your offer. The title of the removed offer is ${title}.</p><br/>` +
    `<p> Have an amazing day,</p>` +
    `<p> Together for Ukraine team</p>`,
});
...
const newApplicationVolunteerMessage = (
  volunteerEmail,
  { refugeeName, volunteerName, title, refugeePhoneNumber, refugeeEmail }
) => ({
  from: `pw.idp.together.for.ukraine@gmail.com`,
  to: volunteerEmail,
  ...
  html:
    ...
    `<p> A refugee has just applied for your offer. This offer's title is: ${title}. Below are the necessary info to get in touch with the applicant.</p>` +
...
const newApplicationRefugeeMessage = (
  refugeeMail,
  { refugeeName, title, description, volunteerContact, isVolunteerAnonymous }
) => ({
  from: `pw.idp.together.for.ukraine@gmail.com`,
  to: refugeeMail,
...
export enum MessageType {
  ...
  OFFER_DECLINED,
  OFFER_REMOVED,
  NEW_APPLICANT_VOLUNTEER,
  NEW_APPLICANT_REFUGEE,
}
