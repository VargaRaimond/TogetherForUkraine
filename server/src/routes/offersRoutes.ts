...
router.get(
  "/pending",
  routesHelper((req, _) => controller.getPendingOffers())
);

router.get(
  "/:personId",
  routesHelper((req, _) => controller.getPersonOffers(req.params.personId))
);

router.get(
  "/",
  routesHelper((req, _) => controller.getOffers())
);
...
router.put(
  ...
  routesHelper((req, res) =>
    controller.updateOffer(req.params.offerId, req.body, res)
  )
);
